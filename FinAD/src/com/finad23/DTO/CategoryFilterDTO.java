...
public class CategoryFilterDTO {
	private String shorts, sub, price, avg, offer, category, pw, name, sex, email, nickname, newsagency, mobilenumber, post, address, reference, image, youtuLink, liveBcLink, snsLink, introduc;
